...
read -p "" firstNumber secondNumber
...
[ $(( $firstNumber % 2)) -eq 0 ] && echo "The firstNumber is even" || echo "The firstNumber is odd"
[ $(( $secondNumber % 2)) -eq 0 ] && echo "The secondNumber is even" || echo "The secondNumber is odd"

[ $(( $secondNumber % $firstNumber )) -eq 0 ] && echo "$secondNumber is a multiple of $firstNumber" ||  echo "$seconNumber is not a multiple of $firstNumber"
...
[ -v USER ] && [ -n "$USER" ] && echo "The variable USER has data in it, assigned value is $USER"
...
read -p "" a b
[ $(( $a != $b )) -eq 0 ] && echo "$a is alphanumerically equal to $b" || echo "$a is not alphanumerically equal to $b"
EOF
